...
//!
//! The golden fixtures in `isha-vector-db-format` prove that individual *structures* survive a format
...
//!
//! ```text
//! VDB_BLESS=1 cargo test -p isha-vector-db-core --test compat
//! ```
//!
...
use isha_vector_db_core::document::{DocumentInput, Include};
