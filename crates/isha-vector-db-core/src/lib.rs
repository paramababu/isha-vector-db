...
// callers to reach into `isha_vector_db_format` for the type of a public API field would leak a crate they
// should never have to name.
pub use isha_vector_db_format::{IndexSpec, MAX_DIMENSION};
pub use path::DbPath;
