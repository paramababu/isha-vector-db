...
//! `isha-vector-db-storage-os` later without changing a single byte on disk.
//!
//! This implementation is a portable, table-driven scalar one. It lives in `isha-vector-db-format`, where
...
///
/// ```
/// # use isha_vector_db_format::crc32c;
