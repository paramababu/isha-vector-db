...
//!
//! `isha_vector_db_core::search::Scorer` is the reference implementation and is deliberately scalar: it
...
//!
//! This routes the same arithmetic through the vectorised kernels in `isha-vector-db-index-flat`, which are
...
use isha_vector_db_index_flat::kernels;
...
mod tests {
    use super::*;
    use isha_vector_db_core::search::{inv_norm, Scorer};
