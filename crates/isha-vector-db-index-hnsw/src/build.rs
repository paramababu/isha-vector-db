...
//
// This crate is not in the same risk class as `isha-vector-db-format`, which parses bytes an attacker may
...
use isha_vector_db_core::index::VectorSource;
...
pub(crate) fn decode_rows(
    source: &dyn VectorSource,
) -> Result<Vec<(isha_vector_db_core::document::RowId, Vec<f32>, f32)>> {
...
pub(crate) fn extend(
    graph: &mut Graph,
    rows: &[(isha_vector_db_core::document::RowId, Vec<f32>, f32)],
    metric: Metric,
    params: &HnswParams,
) {
...
pub(crate) fn build_from(
    rows: Vec<(isha_vector_db_core::document::RowId, Vec<f32>, f32)>,
    dimension: usize,
    metric: Metric,
    params: &HnswParams,
) -> Graph {
...
mod diagnostics {
    ...
    use isha_vector_db_core::index::RowVisitor;
    use isha_vector_db_core::search::inv_norm;
