...
//!
//! Every failure throws `dev.isha.vectordb.VdbException` carrying the stable `VDB-nnnn` code. A JNI method
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_openDatabase<'local>(
    ...
    match Database::open_with_index(
        ...
        config,
        Arc::new(SystemClock),
        Arc::new(isha_vector_db_index_flat::FlatIndex::new()),
    ) {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_closeDatabase<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_flushDatabase<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_listCollections<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> JObjectArray<'local> {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_openCollection<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    db_handle: jlong,
    name: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_freeCollection<'local>(
    _env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_dropCollection<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    db_handle: jlong,
    name: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_upsert<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_delete<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_contains<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_count<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> jlong {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_flushCollection<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_search<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_resultCount<'local>(
    _env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_resultId<'local>(
    env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    index: jint,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_resultScore<'local>(
    _env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    index: jint,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_freeResult<'local>(
    _env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_metadataNew<'local>(
    _env: JNIEnv<'local>,
    _class: JClass<'local>,
) -> jlong {
    into_handle(isha_vector_db_core::metadata::Metadata::new())
}

/// Release a metadata builder.
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_metadataFree<'local>(
    _env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) {
    // SAFETY: the Java layer guarantees the handle came from `metadataNew` and is used once.
    drop(unsafe { drop_handle::<isha_vector_db_core::metadata::Metadata>(handle) });
}
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_metadataSet<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    key: JString<'local>,
    ...
    // SAFETY: the Java layer guarantees a live handle.
    let Some(metadata) = (unsafe { as_mut::<isha_vector_db_core::metadata::Metadata>(handle) })
    else {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_upsertWithMetadata<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    id: JString<'local>,
    ...
    if metadata != 0 {
        ...
        let Some(m) = (unsafe { as_ref::<isha_vector_db_core::metadata::Metadata>(metadata) })
        else {
            throw_msg(&mut env, "the metadata builder is closed");
            return JNI_FALSE;
        };
...
struct FilterStack {
    stack: Vec<isha_vector_db_core::filter::Filter>,
}

/// Create a filter builder.
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_filterNew<'local>(
    _env: JNIEnv<'local>,
    _class: JClass<'local>,
) -> jlong {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_filterFree<'local>(
    _env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_filterCompare<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    field: JString<'local>,
    ...
    use isha_vector_db_core::filter::Filter as F;
    let built = match op {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_filterUnary<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    field: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_filterCombine<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    combinator: jint,
    ...
    let operands: Vec<isha_vector_db_core::filter::Filter> =
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_filterDepth<'local>(
    _env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_searchFiltered<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    query: JFloatArray<'local>,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_collectionStats<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_compact<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_dev_isha_vectordb_Native_verify<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    level: jint,
